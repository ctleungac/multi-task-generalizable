...
def main():
    ...
    num_runs = 1  # Number of full re-trainings
    embeddingDim = 80
    batchsize = 256
...
#                 )(maxpool_2)
                ...
                #CE_dense_2 = layers.Dropout(0.25)(CE_dense_2)
                ...
                #mse_1 = layers.BatchNormalization()(mse_1)
                ...
                #mse_2 = layers.BatchNormalization()(mse_2)
...
#                 )
    ...
    # If you prefer CSV:
    df.to_csv("./results/RLA_cifar_quanti_snr529.csv", index=False)
