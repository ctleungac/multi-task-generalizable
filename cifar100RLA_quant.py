...
def main():
    ...
    for snr_train in SNR_train_list:
        ...
        for lambda_val in lambda_list:
            ...
            # Encoder
            encoder_1 = layers.Conv2D(96, (3, 3), padding='same')(input_layer)
            encoder_1 = layers.BatchNormalization()(encoder_1)
            encoder_1 = layers.Activation('relu')(encoder_1)
            
#             encoder_2 = layers.Conv2D(32, (3, 3), padding='same')(encoder_1)
#             encoder_2 = layers.BatchNormalization()(encoder_2)
#             encoder_2 = layers.Activation('relu')(encoder_2)
...
#             )(maxpool_2)
            ...
            CE_dense_2 = layers.Activation('relu')(CE_dense_2)
            CE_output = layers.Dense(100, activation='softmax', name='CE')(CE_dense_2)


            # Reconstruction head
            mse_1 = layers.Conv2DTranspose(32, kernel_size=3, padding='same')(noise_layer)
            mse_1 = layers.Activation('relu')(mse_1)
            upsample1 = layers.UpSampling2D((2,2))(mse_1)
            mse_2 = layers.Conv2DTranspose(32, kernel_size=3, padding='same')(upsample1)
            mse_2 = layers.Activation('relu')(mse_2)
...
#             )
            ...
            embedding_network.save("embedding_network_100.h5")
            ...
            for i in range(label2_list.shape[0]):
                ...
                for snr_test in SNR_test_list:
                    ...
                    embedding_network_2 = tf.keras.models.load_model("embedding_network_100.h5", compile=False)
                    ...
                    CE_output2 = tf.keras.layers.Dense(100, activation='softmax', name='CE2')(CE_dense_3)
...
#                     )
    ...
    # If you prefer CSV:
    df.to_csv("RLA_cifar100_quant1.csv", index=False)

    print("Training complete. Results saved to 'RLA_cifar100_quant.xlsx'.")
