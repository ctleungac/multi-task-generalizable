...
#                             )(encoder_2)
                ...
                # mse_decoder_1 = tf.keras.layers.Dense(256, activation='relu')(mse_decoder_1)
                ...
                for i in range(label2_list.shape[0]):
                    ...
                    for snr_test in SNR_test_list:
                        ...
                        CE_dense_2 = tf.keras.layers.Dense(80, activation='relu')(noise_layer_1)
                        CE_dense_3 = tf.keras.layers.Dense(80, activation='relu')(CE_dense_2)
    ...
    # If you prefer CSV:
    df.to_csv("./results/RLA_Fmnist_quanti_dynamic_2.csv", index=False)

    print("Training complete. Results saved to 'RLA_Fmnist_quanti_dynamic.xlsx'.")
